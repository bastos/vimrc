" Bastheme colorscheme
"
" Maintainer:   Tiago Bastos <contact@tiagobastos.me>
...
if &background == "dark"
  ...
  hi Boolean      gui=NONE guifg=Red3 guibg=NONE
	hi Comment guifg=#999999 ctermfg=246 guibg=#ffffff ctermbg=255 gui=italic cterm=italic
